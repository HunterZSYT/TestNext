...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: RJaVTQcYmqWT/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__k13Ec)}>
        <div className={classNames(projectcss.all, sty.column__k6SsV)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column___8WFhP)}>
          <div className={classNames(projectcss.all, sty.columns__fGxL)}>
            <div className={classNames(projectcss.all, sty.column___51TkB)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__vge1W)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__nrwUs)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__akdt6)}>
                {renderPlasmicSlot({
