...
import sty from "./PlasmicProjectRelaunch.module.css"; // plasmic-import: m4-OuH9BMUY3/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section___56R9V)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__nQ5Q5)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__zGzYr)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__erWd)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__eq9FA)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__taJl)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__ikmfY)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__xrNo2)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__adm1Y)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns___64OC)}
                >
                  <div className={classNames(projectcss.all, sty.column___6BO)}>
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__pScI)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__gJa1P)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__g2Ra)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox___9Nl4S)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__xyLl5)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__dKo0T)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__m1AIx)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__tvh3C)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__mBveo)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__sgwbp)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__sac7O)}
              >
                <div className={classNames(projectcss.all, sty.column__gbmVn)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__kFc5W
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column___0364H)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__sgsqv
                    )}
