...
import sty from "./PlasmicNavigationBar.module.css"; // plasmic-import: hRYXJXZeXN2B/css
  ...
  return (
    <NavigationBar
      ...
      closeButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__pItSv)}
          displayHeight={"auto"}
      ...
      openButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__jNxxn)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"none"}
          displayMinHeight={"0"}
