...
import sty from "./PlasmicWebVisualDesign.module.css"; // plasmic-import: 7W19TRf1n6fF/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__ylTgc)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__vJyKv)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__fkAhV)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__kBtHy)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___0ZXwj)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___6G0Mk)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__ptPjb)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__rmqts)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__phGsb)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns__cltZ9)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__sNrWk)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__jCchO)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column___3Brmy)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__yHkyl)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__hJnWk)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section___3MRie)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__wgkjX)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__squS)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__cHAl4)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__jIsQ4)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__tcw9J)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns___6ZKy)}
              >
                <div className={classNames(projectcss.all, sty.column__wGeAl)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__t0Dbx
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__b4Xgs)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__g0OoY
                    )}
