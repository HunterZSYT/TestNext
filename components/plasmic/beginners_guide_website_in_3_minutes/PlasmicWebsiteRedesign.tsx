...
import sty from "./PlasmicWebsiteRedesign.module.css"; // plasmic-import: JYyv-960Ly0O/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__fSq4G)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__dCvJm)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__cBfEl)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__iQSxR)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__hlhf4)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___2Vdh4)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section___0NJm7)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__z7Yei)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__imhug)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns__yj5Dp)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__rueQu)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___9XkcK)}
                      displayHeight={
                  ...
                  <div className={classNames(projectcss.all, sty.column__r6BU)}>
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___6MrM)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__e7Qay)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__bvEhv)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox___52Ao7)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__bWcW)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox___8M57A)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__sZHwx)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__fsmI6)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__kYvJr)}
              >
                <div className={classNames(projectcss.all, sty.column__dvexw)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__sD91D
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column___7D2Ry)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__ul2Sp
                    )}
